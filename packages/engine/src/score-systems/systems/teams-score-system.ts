...
const teamFormDefinition = [
     ...
     { name: "teamName", fieldType: "text", valueType: "string", displayName: "Team name", optional: false, defaultValue: "" },
     { name: "teamColor", fieldType: "text" /* color ? */, valueType: "string", displayName: "Team color", optional: false, defaultValue: "blue" }
