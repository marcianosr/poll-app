...
import { ZodSchemaType } from "./schema/zodSchemaType";
import { FormSchema } from "remix-forms";
...
export const SchemaForm = <Schema extends TypedForm>({
	...
	type BaseSchema = FormSchema<z.ZodObject<{ [x: string]: z.ZodTypeAny }>>;

	return (
		<RemixForm
			schema={zodSchema as unknown as BaseSchema}
